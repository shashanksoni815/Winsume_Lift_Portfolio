        ...
        >
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 shadow-2xl">
            <div className="text-center mb-6">
              ...
              <p className="text-orange-500 text-xs uppercase tracking-widest mb-1.5">SECURITY PORTAL</p>
              <h1 className="font-['Great_Vibes'] text-4xl text-white mb-1.5">User Login</h1>
              <div className="w-20 h-0.5 bg-orange-500 mx-auto mb-3"></div>
              <p className="text-white/60 text-xs">Client Access Dashboard</p>
            </div>
        ...
        >
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-orange-500 text-xs uppercase tracking-widest mb-2">SECURITY PORTAL</p>
