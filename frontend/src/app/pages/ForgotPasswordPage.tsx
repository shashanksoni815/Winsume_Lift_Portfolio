            ...
            {!submitted ? (
              <>
                <div className="text-center mb-6">
                  ...
                  <p className="text-orange-500 text-xs uppercase tracking-widest mb-1.5">USER PORTAL</p>
                  ...
                  <p className="text-white/60 text-xs">Enter your email to reset your password</p>
                </div>
              ...
              >
                ...
                <p className="text-green-500 text-xs uppercase tracking-widest mb-2">EMAIL SENT</p>
