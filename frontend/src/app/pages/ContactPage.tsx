  ...
  <a href="tel:+917089344991" className="block hover:text-orange-400 transition">
    +91 70893 44991
            ...
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              <form onSubmit={handleSubmit} noValidate className="bg-[#2a4544] rounded-2xl p-8 lg:p-10">
                {isSubmitted ? (
                  <div className="text-center py-12">
                    <div className="w-20 h-20 bg-orange-500/20 border border-orange-500/30 rounded-full flex items-center justify-center mx-auto mb-6">
                      <Send size={32} className="text-orange-500" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onBlur={handleBlur}
                          required
                          className={`w-full bg-[#1a3332] border rounded-lg px-4 py-3 text-white focus:outline-none transition-colors placeholder:text-white/30 ${
                            fieldError('name')
