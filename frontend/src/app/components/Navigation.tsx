...
export function Navigation() {
  ...
  // NEW: handle cart click with login guard
  ...
  const handleLogoClick = () => { navigate('/'); setIsMobileMenuOpen(false); };
  // const handleInquiryClick = () => { navigate('/bespoke-proposal'); setIsMobileMenuOpen(false); };
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            {/* Desktop Navigation */}
            <div className="hidden md:flex items-center space-x-8">
              <button onClick={handlePortfolioClick} className="text-white/80 hover:text-orange-500 transition-colors text-sm uppercase tracking-wider">Portfolio</button>
              <button onClick={handleCollectionClick} className="text-white/80 hover:text-orange-500 transition-colors text-sm uppercase tracking-wider">Collection</button>
              <button onClick={handleServicesClick} className="text-white/80 hover:text-orange-500 transition-colors text-sm uppercase tracking-wider">Services</button>
              <button onClick={handleAboutClick} className="text-white/80 hover:text-orange-500 transition-colors text-sm uppercase tracking-wider">About</button>
              <button
              ...
              {/* <button onClick={handleInquiryClick} className="bg-orange-500 text-white px-6 py-2.5 rounded-full hover:bg-orange-600 hover:scale-105 transition-all text-sm uppercase tracking-wider shadow-lg">
                Inquire
              </button> */}
            </div>
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden bg-[#1a3332]/95 backdrop-blur-md rounded-lg mb-4 p-4">
              <div className="flex flex-col space-y-4">
                ...
                {/* <button onClick={handleInquiryClick} className="bg-orange-500 text-white px-6 py-3 rounded-full hover:bg-orange-600 transition-all text-left text-sm uppercase tracking-wider">
                  Inquire
                </button> */}
              </div>
            </div>
