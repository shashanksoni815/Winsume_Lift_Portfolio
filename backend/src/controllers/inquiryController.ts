...
export const listInquiries = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
export const getInquiry = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
...
export const listInquiriesForUser = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    if (!req.user) {
      throw createHttpError(401, "Authentication required");
    }
