...
import { listPublicBlogs, listPublicCategories, getPublicBlog, getBlogStats, listBlogs, getBlog, createBlog, updateBlog, updateBlogStatus, toggleFeatured, deleteBlog } from "../controllers/blogController.js";
...
router.patch("/:id", requireAuth, requireRole("admin"), upload.fields([
    { name: "heroImage", maxCount: 1 },
    { name: "authorImage", maxCount: 1 }
]), updateBlog);
